						...
						<div class="product-info">
							<div class="nav-main">
								...
								<ul class="nav nav-tabs" id="myTab" role="tablist">
									...
									<li class="nav-item"><a class="nav-link" data-toggle="tab" href="#women" role="tab"><?php echo $category->nom;?></a></li>
							       <?php endforeach ?>
								</ul>
								<!--/ End Tab Nav -->
							</div>
											...
											<div class="col-xl-3 col-lg-4 col-md-4 col-12">
												<div class="single-product">
													...
													<div class="product-content">
														<h3><a href="product-details.html"><?php echo $product->designation; ?></a></h3>
														<div class="product-price">
															<span><?php echo $product->remise;?>dh</span>
														</div>
													</div>
												</div>
											</div>
